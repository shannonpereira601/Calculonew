...
/**
 * Entity mapped to table "MCQ".
 */
public class Mcq implements EntityGetter{
    ...
    private transient McqDao myDao;
    ...
    public Mcq(Long id, String name, Long topicId) {
        this.id = id;
        this.name = name;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getMcqDao() : null;
    }
