    ...
    */
    ...
    public Note readEntity(Cursor cursor, int offset) {
        Note entity = new Note( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getLong(offset + 3) // topicId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Note entity, int offset) {
        ...
        entity.setTopicId(cursor.isNull(offset + 3) ? null : cursor.getLong(offset + 3));
     }
