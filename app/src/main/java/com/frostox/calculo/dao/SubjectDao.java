...
public class SubjectDao extends AbstractDao<Subject, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property StandardId = new Property(2, Long.class, "standardId", false, "STANDARD_ID");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SUBJECT\" (" + //
                ...
                "\"STANDARD_ID\" INTEGER);"); // 2: standardId
    }
    ...
    public Subject readEntity(Cursor cursor, int offset) {
        Subject entity = new Subject( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getLong(offset + 2) // standardId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Subject entity, int offset) {
        ...
        entity.setStandardId(cursor.isNull(offset + 2) ? null : cursor.getLong(offset + 2));
     }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getStandardDao().getAllColumns());
            builder.append(" FROM SUBJECT T");
            builder.append(" LEFT JOIN STANDARD T0 ON T.\"STANDARD_ID\"=T0.\"_id\"");
            builder.append(' ');
    ...
    protected Subject loadCurrentDeep(Cursor cursor, boolean lock) {
        ...
        Standard standard = loadCurrentOther(daoSession.getStandardDao(), cursor, offset);
