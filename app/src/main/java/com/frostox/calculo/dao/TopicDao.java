...
public class TopicDao extends AbstractDao<Topic, Long> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Topic entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(Topic entity) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Topic entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    protected Topic loadCurrentDeep(Cursor cursor, boolean lock) {
        Topic entity = loadCurrent(cursor, 0, lock);
    ...
    public Topic loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<Topic> queryDeep(String where, String... selectionArg) {
